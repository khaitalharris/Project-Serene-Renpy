...
define config.name = _("Project Serene")
...
define build.name = "ProjectSerene"
...
## Hide the dialogue box when no dialogue is being spoken.
...
define config.save_directory = "ProjectSerene-1714927257"
