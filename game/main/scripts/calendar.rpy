...
default theweekday = 1
default full_weekday_name = True
...
label calendar(direction):
    ...
    python:
        ...
        imgWidth = 330 #Width of buttons; change if image changes
        posY = 710
        posX = 10
