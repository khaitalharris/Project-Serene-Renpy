label chapter2:
    ...
    se "(Somehow this building looks familiar. I think I'm here.)"
    menu:
        extend ""
    ...
    label enter_amara_shop:
        narrator "You enter the shop, not knowing what to expect inside."

        narrator "The shopkeeper, Amara, can be seen chatting with one of her regulars. Her long hair seems to bounce around her hips as she speaks." 
        Amara "Haha, see. What did I tell you! Have some confidence! The dress is perfect on you."
        narrator "Amara stands behind a customer facing the shop mirror. She is wearing a beautiful crimson dress that seems to perfectly fit her boisterous frame." 
        ...
        narrator "You watch Amara glide through her shop like a professionally trained ballerina, every movement fluid and never lacking precision." 
        narrator "It is evident she knows every inch of her shop despite the incredulous amount of random trinkets and items seemingly strewn everywhere." 
        narrator "This shop is organized chaos, and this is her song and dance."  
        se "(It seems like she gets along well with her customers. Maybe I should come back another time when she's not busy.)"
        ...
        $ Customer = "Christine"
        narrator"In an instant, Amara is already in your face, her long hair hanging like a halo around your peripherals." 
        narrator"She bends down to meet your eye level, clearly intrigued."
        narrator"You can't help but stare deeply into her brown eyes, admiring the specks of gold sprinkled around her iris like fairy dust."  
        Serene "...Hi?"
        Amara "Those blue eyes..."
        Amara "In all my years I've never seen such a thing." 
        Amara "And{w=0.5} your{w=0.5} {i}HAIR?{/i}{w=1.5} Fascinating."
        Serene "Oh,{w=0.5} I mean I guess my hair does look a little blue if you shine the light the right way-"
        Serene "Wait{w=0.5} blue eyes? I don't have blue eyes??"
        Amara "And that bracelet.."
        #*Amara grabs your wrist and inspects the bracelet you acquired back in the cave.
    ...
    label amara_respond:
        narrator"Serene opens her bag and shows Amara the chalice."
        Amara "I knew it." 
        extend "{i}I KNEW IT.{/i}" 
        Amara "You're the hero that old man kept yapping about."
        Amara "Still, you seem a little strange." 
        Amara "Besides the hair and eyes,{w=0.8} I really don't sense anything heroic about you."
        Customer "Ahhh!!"
        Amara "Hold on, you stay RIGHT there. {w=2.0}I'll hold on to this in the meantime."  
        #- *Amara nonchalantly places the Chalice behind the store counter* 
        Amara "What did you find Christine?! {w=1.5}AHHHH. That hairpin looks Gorgeous on you." 
        Amara "It's on the house, this piece was made for you. You look absolutely divine, darling." 
        se "(It looks like Amara's busy again. Should I look around?)"
    menu:
        extend ""
    ...
    label amara_search:
        ...
        se "(I really have changed. Was it when I got transported here?)"
        narrator "You look down and inspect the bracelet around your wrist." 
        se "(Did the bracelet do this?!)"
        narrator "Suddenly, an elderly woman appears behind you in the mirror."
        ...
        se "(If I close my eyes, this will all disappear.)"
        narrator "You squeeze your eyes shut for a brief moment." 
        narrator "When your eyes flutter open, your blurry vision reveals the same old woman staring at you from behind."
        Elder "Still here."
        Serene ":("
        Elder "I'll be brief. I'm here to help make some sense of your current situation." 
        Elder "Look at your bracelet. Now clear your mind. Think of your journal."
        Serene "My journal...?" 
        narrator "Your mind flashes back to your journal back at the office." 
        se "(I nearly forgot. I always kept my journal on me...)"

        # - The flashback of you and your coworker during your training days continues.
        Devon "How are you writing so fast?!"
        Serene "You don't write things down when you first learn something? {w=2.0}That's like,{w=0.5} the best way to learn something."
        ...
        show text "Important information will now automatically be added to your journal for reference." with dissolve
        pause(3)
        ...
        se "(Yeah, I am absolutely going insane.)"
        Amara "Well, look at you admiring yourself." 
        Amara "Be careful now. Stare too long, and you'll start seeing spirits." 
        Amara "Come with me; I have something for you."
        # - *Scene Transitions to a dusty bedroom upstairs*
        narrator "Amara leads you up the creaky stairs and into an empty guest room. She opens the curtains in one swift motion, dust particles flying everywhere." 
        narrator "Covering her mouth with her sleeve and waving the air around her with her other sleeve, she turns around to face you." 
    ...
    label amara_room:
        ...
        narrator "You hear Amara make her way back downstairs; somehow, the creaky stairs don't seem to creak for her." 
        se "(The exhaustion finally caught up to me. I should get some sleep.)"
        narrator "Your head hits the pillow and you instantly fall asleep for the night." 
        with fade
        ...
        Bell "SUNRIIIIIISE!" 
        #*GONGGGGG*"
        narrator "Still in bed, you attempt to cover your ears with a pillow." 
        # - *Shuffling noises can be heard from downstairs*
        # - *Amara's Shouting from downstairs*
        Amara "Sereneeeee! A little help please!"
        narrator "Still half-asleep, you scramble out of bed and head downstairs."
        Serene "Uh. Cominggggg!"
        # - *Amara can be seen downstairs lugging a large heavy chest*
        Amara "Phew. This never gets any easier. Mind if I use your help to unpack?"
        ...
        Amara "What do you mean? That's the best part. I have a deal with the Merchant Guild." 
        Amara "Every trader gets a chest before major festivals. Keeps things more exciting."
        narrator "You open up the chest. It's overflowing with beads and colorful powder."
        ...
        se "(Hmmm. I'm not really sure what the powder is for though. That's a new one.)"
        ...
        Serene "Right."
        narrator "You work with Amara to put up the stock." 
        ...
        Amara "Well..."
        se "(Something seems wrong with Amara, should I probe deeper?)"

    menu:
        extend ""
        "Press her for a better answer.":
            Amara "Really?! You would?! Oh, I mean I couldn't! I wouldn't want to inconvenience you! I mean I'm sorry I just-- *sigh* Here I go again..."
            se "(It seems like she's getting a little flustered. Should I keep going?)"
    ...
    menu amara_assistant:
        ...
        "\"Why are you so nervous?\"":
            ...
            se "(\"Do it right?\" I wonder what that means. Maybe I shouldn't pressure her any further.)"
    ...
    label amara_assistant3:
        ...
        se "(I've never run my own business before. Could I really do something like that...?)"
        ...
        Serene "You have {i}another{/i} place besides this?"
    ...
    label amara_help2:
        ...
        se "(Her father?! Even I could tell that a family with an item like that must be rolling in cash.)"
        ...
        se "(I can feel her strong ambition. I'm sure there's something I can do to help her.)"
        Serene "Well in that case, let's make this a partnership. You help me, and I'll help you!"
        Amara "You're so hard-headed! Let's start as friends, maybe first?"
        ...
        narrator "Amara guides you to the next building. She said it was next door, but it really was a few blocks away. I guess this is how normal long walks are around here."

        narrator "Amara flamboyantly shows off the building, her long hair bouncing around her waist in excitement." 
        ...
        narrator "The room is surprisingly quiet as you step inside." 
        ...
        Amara "Leif...You know sure well I don't sell that stuff." 
        Amara "I specialize in clothing & jewelry, mister. How long have you known me?"
        Leif "See, that's the thing Amara. Have you ever thought of expanding? {w=2}We have so many clothing stores already." 
        ...
        se "(It looks like Amara and Leif have an interesting relationship. Should I jump into the conversation?)"
    ...
    label meet_leif:
        ...
        Amara "We'll just have to see about that then, huh?" 
        #*Amara gives a wide grin as she spins around to introduce you* 
        ...
        se "(Reminds me a lot of my lunch breaks with Trisha.)"
        ...
        se "(I guess some things never change.)"
        # *DONGGG*
        Bell "AFTERNOOOOOOOOON!" 
        #*DONGGGG* 
        Bell "AFTERNOOOOOON!"
        ...
        narrator "Amara can already be seen long gone."
        Serene "...That was fast." 
        Serene "So thennn...Leif. How's...life...?"
        narrator "Leif can already be seen at his desk, busy with his sketch."
        #*Yelling from across the room*
        Leif "Sorry. Serene, right?"
        ...
        se "(Leif looks busy; maybe I should come back another time.)"
        with fade
